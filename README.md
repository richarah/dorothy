...
Due to X11 issues with the macOS implementation of Docker, the TUI (Text User Interface) branch of Dorothy is recommended for Mac users. This branch may be cloned with the following command:
```
